    ...
    <div class="container">
        ...
        <form action="<?php echo e(route('services.update', $service->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input name="name" type="text" class="form-control" id="name" value="<?php echo e(old('name', false) ? old('name') : $service->name); ?>">
            </div>
            <div class="form-group">
                <label for="name">Description</label>
                <textarea name="description" id="description" cols="30" rows="10" class="form-control"><?php echo e(old('description', false) ? old('description') : $service->description); ?></textarea>
            </div>
...
<?php $__env->startSection('scripts'); ?>
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#questions").select2("trigger", "select", {data: <?php echo json_encode($q->only(['id', 'name', 'question'])); ?>});
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

            <?php $__currentLoopData = \App\Models\ServiceQuestion::whereIn('id', old('questions', []))->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            $("#questions").select2("trigger", "select", {data: <?php echo json_encode($q->only(['id', 'name', 'question'])); ?>});
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
