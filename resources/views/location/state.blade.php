        ...
        <div class="container text-left">
            <div class="row">
                <div class="col-lg-8 col-md-10 col-sm-12 header-line">
                    <h1 class="header-title-1 tp-margin-bottom--quad">Find local professionals that can service your needs.</h1>
                    ...
                    <div class="scrolling-wrapper services-item services-item-scroll">
                        @foreach($services as $service)
                            ...
                            <div class="card h-100">
                                ...
                                <a href="{{url($url)}}">
                                    <img class="card-img-top" src="{{ asset(str_replace("public","storage", $service->resized_featured_image)) }}" alt="" onerror="this.src='{{url('/default.png')}}'">
                                </a>
                                <div class="card-body">
                                    <h4 class="card-title">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12">
                    <img src="http://www.ideamia.co/wp-content/uploads/2018/07/satellite-map-of-us-at-night-satellite-map-of-north-america-at-night-city-lights-visible-earth-tearing-usa-best-nasa-noaa-satellite-reveals-new-views-earth-at-night-with-map-of-satellite-map-of-us-at.png" style="width: 400px;margin-bottom: 25px;max-width: 100%;box-shadow: 0 0 5px 0 rgba(204, 204, 204, 0.75);padding: 10px;background: #fff;">
                </div>
                ...
                <div class="col-lg-12 mx-auto">
                    ...
                    <ol class="states-list__list">
                        @foreach($state->cities as $city)
                            <li>
                                <a class="one-link--dark one-color--black-300" href="{{url($state->state_code.'/'.$city->slug)}}">{{$city->city}}, {{$city->state_code}}</a>
                            </li>
                        @endforeach
                    </ol>
                </div>
