    ...
    <div class="container py-4">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-header">{{ __('Basic Info') }}</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('user.settings.updateInfo') }}" aria-label="{{ __('Basic Info') }}">
                            @csrf
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('user.settings.updatePassword') }}" aria-label="{{ __('Change Password') }}">
                            @csrf
